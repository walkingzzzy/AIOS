...
PY_COMPILE_TARGETS = [
    ...
    'scripts/test-placeholder-implementation-gate-smoke.py',
    ...
    'scripts/test-office-ooxml-smoke.py',
    'scripts/test-browser-session-smoke.py',
    ...
    'scripts/test-runtimed-backend-smoke.py', 'scripts/test-runtimed-worker-contract-smoke.py', 'scripts/test-runtimed-managed-worker-smoke.py', 'scripts/test-runtimed-managed-worker-restart-smoke.py', 'scripts/test-runtimed-managed-worker-restart-exhausted-smoke.py', 'scripts/test-runtimed-events-smoke.py', 'scripts/test-runtimed-hardware-profile-managed-worker-smoke.py', 'scripts/test-runtimed-jetson-platform-worker-smoke.py', 'scripts/test-runtimed-jetson-platform-vendor-helper-smoke.py', 'scripts/test-runtimed-jetson-platform-vendor-helper-failure-smoke.py', 'scripts/test-runtimed-jetson-platform-vendor-worker-smoke.py', 'scripts/test-runtimed-jetson-platform-worker-failure-smoke.py', 'scripts/test-shell-desktop-smoke.py', 'scripts/test-shell-session-smoke.py', 'scripts/test-deviced-smoke.py',
...
def validate_steps(host_target: str, bin_dir: str) -> list[Step]:
    return [
        ...
        Step('Placeholder implementation gate smoke', [PYTHON, 'scripts/test-placeholder-implementation-gate-smoke.py']),
        ...
        Step('Tier1 machine bring-up reports smoke', [PYTHON, 'scripts/test-tier1-machine-bringup-reports-smoke.py']),
        ...
        Step('Runtimed Jetson platform vendor helper failure smoke', [PYTHON, 'scripts/test-runtimed-jetson-platform-vendor-helper-failure-smoke.py', '--bin-dir', bin_dir]),
        ...
        Step('Browser session smoke', [PYTHON, 'scripts/test-browser-session-smoke.py']),
        Step('Office provider smoke', [PYTHON, 'scripts/test-office-provider-smoke.py']),
        Step('Office OOXML smoke', [PYTHON, 'scripts/test-office-ooxml-smoke.py']),
